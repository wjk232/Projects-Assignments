package com.app.wjk232.messagingapp.API;
...
/**
 * Created by kbaldor(professor) on 7/7/16.
 */
public class Crypto {
    ...
    public String getPrivateKeyString(){
        return Base64.encodeToString(myRSAKeyPair.getPrivate().getEncoded(),Base64.DEFAULT);
    }
