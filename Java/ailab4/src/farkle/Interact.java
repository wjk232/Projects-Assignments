...
public class Interact {
    ...
    public static void main(String[] args) {
        ...
        Runnable envir = new Farkle(envirIn, envirOut);
        // a hack to avoid redundant printing
        if (debug) ((Farkle) envir).askuser = true;
        Runnable agent = new FarklePlayer(agentIn, agentOut);
